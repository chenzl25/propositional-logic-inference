...
SymbolList* logic_create_symbol_list() {
...
RelationList* logic_create_relation_list() {
  return new RelationList();
}

RelationList* logic_chain_relation_list(RelationList* relation_list, std::string* symbol, Sentence* sentence) {
